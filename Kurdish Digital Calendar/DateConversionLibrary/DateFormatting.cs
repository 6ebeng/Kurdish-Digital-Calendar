...
namespace Kurdish_Digital_Calendar.DateConversionLibrary
{
    ...
    {
        public static string FormatDate(int Day, int Month, int Year, int aWeekDay, int formatChoice, string monthName, string weekDayName, string separator = ", ",string suffix = "")
        {
            ...
            switch (formatChoice)
            {
                ...
                case 11:
                    return $"{Year}/{dayFormatted}/{monthFormatted}{suffix}";
                default:
