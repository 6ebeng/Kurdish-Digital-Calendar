...
namespace KDCLibrary.Helpers
{
    ...
    {
        public void InitializeDropDown(RibbonDropDown dropDown, List<string> items, Microsoft.Office.Tools.Ribbon.RibbonFactory ribbonFactory)
        {
        ...
        public void UncheckOtherCheckBoxes(IEnumerable<RibbonCheckBox> checkBoxes, RibbonCheckBox exceptThis)
        {
            foreach (var checkBox in checkBoxes)
            {
